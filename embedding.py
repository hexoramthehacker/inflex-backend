...
REWRITE_MODEL = ENV.get("REWRITE_MODEL", "gemini-2.0-flash")
EMBEDDING_MODEL = ENV.get("EMBEDDING_MODEL", "models/gemini-embedding-2-preview")
GEMINI_API_KEY = ENV.get("GEMINI_API_KEY") or ENV.get("GEMINI_API") or ENV.get("AI_API")
